    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="students.php" method="post">
				...
				<div class="form-group mx-sm-3 mb-2">
			   <button name="sub" class="btn btn-success mb-2">Active ODL Students</button>
			   </div>
		   </form>
		   <?php
		   if(isset($_POST['sub'])):
...
and studentunits.status='1'");			
        ?>
				...
				<div class="col-md-8">       
					<h2 class="text-center">Active ODL Students</h2><hr>
				...
				<br>
				<br>
				<form method="post" action="studentsp.php" target="_blank">
