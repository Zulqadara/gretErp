...
<div class="clearfix"></div>
		  		<h2 class="text-center">Fees With No Balance per Payable Item</h2><hr>
			<form class="form" action="fees.php" method="post">
			   ...
			   <div class="form-group mb-2">
									...
									?>
									<input type="radio" name="type" value="<?=$pay['feestypesid'];?>" required> <?=$pay['name'];?><br>
									<?php endwhile; ?>
								</div>
			   <div class="form-group mb-2">
        ...
        ?>
			...
			<form method="post" action="feesp.php" target="_blank">
