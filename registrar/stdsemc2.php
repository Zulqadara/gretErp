    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="stdsemc2.php" method="post">
...
$units = ((isset($_POST['unit']) && $_POST['unit'] !='')?ss($_POST['unit']):'');
				...
				$qu = $db->query("select student.studentnumber as c, (sum(studentfees.tamount) - sum(studentfees.tpaid)) as a, courses.name from student
...
");			
        ?>
				...
				<div class="col-md-8">       
					<h2 class="text-center">Student in Course with No Fee Balance</h2><hr>
				...
				<br>
				<br>
											<form method="post" action="stdsemc2p.php" target="_blank">
