      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="reports.php" method="post">
				...
				<div class="form-group mx-sm-3 mb-2">
			   <button name="sub" class="btn btn-success mb-2">Active ODL Students Registered</button>
			   </div>
		   </form>
		   <?php
		   if(isset($_POST['sub'])):
...
$programs = ((isset($_POST['program']) && $_POST['program'] !='')?ss($_POST['program']):'');
				...
				$qu = $db->query("select count(studentunits.unitid) as c, courses.name from student
...
group by courses.coursesid");			
        ?>
				...
				<div class="col-md-8">       
					<h2 class="text-center">Number of Active ODL Students</h2><hr>
