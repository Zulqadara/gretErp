    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="stdsem.php" method="post">
				...
				<div class="form-group mx-sm-3 mb-2">
			   <button name="sub" class="btn btn-success">Active Students in Semester</button>
			   </div>
		   </form>
		   <?php
		   if(isset($_POST['sub'])):
...
and studentprogramme.school='$school' and studentprogramme.programmeid='$programs' and studentunits.status='1'");			
        ?>
		
				<div class="col-md-8">       
					<h2 class="text-center">Active Students in Semester</h2><hr>
				...
				<br>
				<br>
			<form method="post" action="stdsemp.php" target="_blank">
