...
<div class="clearfix"></div>
		  		<h2 class="text-center">Applied Students</h2><hr>
			<form class="form-inline" action="applied.php" method="post">
		   ...
		   if(isset($_POST['search'])):
			...
			referenceyear, '/', referencenumber) AS ref
			from student as st
			...
			<table id="table_id" class="display responsive" width="100%">
				...
				<tbody>
					...
					<?php
						...
						<form method="post" action="appliedp.php" target="_blank">
