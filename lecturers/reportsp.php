...
$pdf->Cell(115,10,'Active Students: ', 0, 1, 0);
...
$pdf->Cell(40,-5,'Report Print Date: '.$date3 .'. Processed By:' .$st['staffid'].' - '.$st['name']);
...
$pdf->Cell($w, 10, "Signature", 1, 0, "L", 1); 
$y = 90;
$x2 = 10;  

$pdf->setXY($x2, $y);
$pdf->setFont("Arial","B","9");
$query_result = "select student.studentnumber as c from student
