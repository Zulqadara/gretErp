    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="areports.php" method="post">
...
$stype = ((isset($_POST['stype']) && $_POST['stype'] !='')?ss($_POST['stype']):'');
				...
				$qu = $db->query("select student.studentnumber as c
,COUNT(studentattendance.`status`) AS acount
from student
inner join studentattendance on studentattendance.studentid = student.studentid
where studentattendance.semester='$semester' and studentattendance.`year`='$year' and studentattendance.stage='$stage'
and studentattendance.unitid='$units' and year(studentattendance.dt)='$date' and student.mode='$stype' and studentattendance.status='Present'
group by studentattendance.studentid
");			
        ?>
		
				<div class="col-md-8">       
					<h2 class="text-center">Students Attendance</h2><hr>
				...
				<br>
				<br>
											<form method="post" action="areportsp.php" target="_blank">
