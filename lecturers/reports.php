    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="reports.php" method="post">
				...
				<div class="form-group mx-sm-3 mb-2">
			   <button name="sub" class="btn btn-success mb-2">Active Students Registered</button>
			   </div>
		   </form>
		   <?php
		   if(isset($_POST['sub'])):
...
$units = ((isset($_POST['unit']) && $_POST['unit'] !='')?ss($_POST['unit']):'');
				...
				$qu = $db->query("select student.studentnumber as c from student
...
and studentprogramme.school='$school' and studentprogramme.programmeid='$programs' and studentunits.unitid='$units' and studentunits.status='1'");			
        ?>
		
				<div class="col-md-8">       
					<h2 class="text-center">Active Students</h2><hr>
				...
				<br>
				<br>
							<form method="post" action="reportsp.php" target="_blank">
