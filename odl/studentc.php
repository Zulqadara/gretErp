    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="studentc.php" method="post">
				...
				<div class="form-group mx-sm-3 mb-2">
			   <button name="sub" class="btn btn-success mb-2">Active ODL Students per Course</button>
			   </div>
		   </form>
		   <?php
		   if(isset($_POST['sub'])):
...
and studentunits.status='1' and studentunits.unitid='$units'");			
        ?>
				...
				<div class="col-md-8">       
					<h2 class="text-center">Active ODL Students per Course</h2><hr>
							...
							<?php 
								...
								<?php
									...
									endwhile; ?>
										...
										<form method="post" action="studentcp.php" target="_blank">
