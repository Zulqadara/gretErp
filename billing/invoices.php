...
<div class="clearfix"></div>
		   ...
		   if(isset($_POST['search'])):
			$tos = ((isset($_POST['tos']) && $_POST['tos'] !='')?ss($_POST['tos']):'');		
			$froms = ((isset($_POST['froms']) && $_POST['froms'] !='')?ss($_POST['froms']):'');		
			$sresults = $db->query("select *,student.studentnumber as stnum FROM studentfees sf
			inner join studentinvoice st on st.studentfeesid = sf.studentfeesid
										inner join studentprogramme on sf.studentprogrammeid = studentprogramme.studentprogrammeid
