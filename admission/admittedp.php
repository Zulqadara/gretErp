...
$pdf->Cell(115,10,'Registered Students: ', 0, 1, 0);
...
$pdf->Cell($w, 10, "Status", 1, 0, "L", 1); 
$pdf->Cell($w, 10, "Study Center", 1, 0, "L", 1);
...
$x=$pdf->getx();
$pdf->myCell($w,$h,$x,$row['status']);
$x=$pdf->getx();
$pdf->myCell($w,$h,$x,$row['center']);
$pdf->Ln();
$y += 8;
		$count++;
		        if ($y > 170)   
