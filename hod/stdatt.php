    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12" align="center">
		   ...
		   <form class="form-inline" action="stdatt.php" method="post">
...
$units = ((isset($_POST['unit']) && $_POST['unit'] !='')?ss($_POST['unit']):'');
				...
				$qu = $db->query("select student.studentnumber as c, count( student.studentnumber) as ct from student
...
group by student.studentid");			
        ?>
				...
				<div class="col-md-8">       
					<h2 class="text-center">Student Attendance</h2><hr>
				...
				<form method="post" action="stdattp.php" target="_blank">
